...
def generate_base_components():
    ...
    return {
        "phase2": {
            ...
            "path": "scatterplot_gaze/assets/phase2_gaze.jsx",
            "response": [
                {
                    "id": "answer",
                    "prompt": "",
        ...
        "phase3": {
            "type": "react-component",
            "path": "scatterplot_gaze/assets/phase3.jsx",
            "response": [
                {
                    "id": "answer",
                    "prompt": "",
...
def create_default_components(fail_link):
    ...
    return {
        "consent": {
            "type": "markdown",
            "path": "scatterplot_gaze/assets/consent.md",
...
def create_gaze_components(fail_link):
    ...
    return {
        "webcamPermission": {
            ...
            "parameters": {"failLink": fail_link},
            "response": hidden("webcamPermission", "Webcam permission"),
            "instructionLocation": "belowStimulus",
            "nextButtonLocation": "belowStimulus"
        },
        "gazeCalibration": {
        ...
        "gazeEnd": {
            "type": "react-component",
            "path": "scatterplot_gaze/assets/GazeEnd.tsx",
            "response": hidden("gazeEnd", "Eye tracking finished"),
            "instructionLocation": "belowStimulus",
            "nextButtonLocation": "belowStimulus"
        }
    }
...
default_components |= create_gaze_components(prolificRedirectionFailedAttentionCheck)
