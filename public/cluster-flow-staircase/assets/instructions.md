...
5. A question appears: *Which one has more items?*
...
diagrams never contain the same number of items, so always pick one, even when you are not sure.
Please keep your eyes on the centre of the screen and keep both hands on the keyboard.

Next you will do eight practice trials. In practice, and only in practice, we tell you whether you
were right.

Press **Enter** to begin the practice trials.
