...
def create_default_components(fail_link):
    ...
    return {
        "consent": {
            "type": "markdown",
            "path": "scatterplot2/assets/consent.md",
            "nextButtonText": "I agree",
            "response": []
        },
        "introduction": {
            "type": "markdown",
            "path": "scatterplot2/assets/introduction.md",
            "response": []
        },
        "phase1_intro": {
            "type": "markdown",
            "path": "scatterplot2/assets/phase1_intro.md",
            "response": []
        },
        "phase2_intro": {
            "type": "markdown",
            "path": "scatterplot2/assets/phase2_intro.md",
            "response": []
        },
        "phase2_examples": {
            "type": "markdown",
            "path": "scatterplot2/assets/phase2_examples.md",
            "response": []
        },
        "phase2_main": {
            "type": "markdown",
            "path": "scatterplot2/assets/phase2_main.md",
            "response": []
        },
        "phase3_intro": {
            "type": "markdown",
            "path": "scatterplot2/assets/phase3_intro.md",
            "response": []
        },
        "attentionCheckFailed": {
            "type": "react-component",
            "path": "scatterplot2/assets/attentionCheck.jsx",
            "parameters": {
                "link": fail_link
            },
            "response": [
