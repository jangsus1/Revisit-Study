...
- A cross means the next pair of diagrams is about to appear.
- Press **F** (or the **left arrow**) if the **first** diagram had more items, **J** (or the **right arrow**) if the **second** did.
